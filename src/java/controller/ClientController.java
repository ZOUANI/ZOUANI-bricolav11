...
//    }
    ...
    public String redirectToLogin() {
     ...
     public void showInscriptionTravauxMaisonForm() {
        RequestContext context = RequestContext.getCurrentInstance();
        context.execute("PF('InscriptionTravauxMaisonDialog').show()");
    }
     public void showInscriptionLocationVoitureForm() {
        RequestContext context = RequestContext.getCurrentInstance();
        context.execute("PF('InscriptionLocationVoitureDialog').show()");
    }
