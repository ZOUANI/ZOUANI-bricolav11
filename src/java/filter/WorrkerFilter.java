 ...
 * @author
 */
@WebFilter("/faces/worker/*")
public class WorrkerFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) {
        ...
        Worker user = (Worker) session.getAttribute("connectedWorker");
        try {
           // if ((user != null && user.getLogin() != null) || req.getRequestURI().endsWith("Login.xhtml") || req.getRequestURI().endsWith("/") || resourceRequest || imageResources) {
            if ((user != null && user.getLogin() != null)  || req.getRequestURI().endsWith("/") || resourceRequest || imageResources) {
